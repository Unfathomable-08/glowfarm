        ...
        <div className="relative flex flex-col items-center" style={{ height }}>
            ...
            <div className="w-[6px] md:w-2 bg-zinc-800 h-full rounded-t-full relative">
                ...
                <motion.div
                    ...
                    viewport={{ once: false }}
                    className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-white blur-[60px] rounded-full pointer-events-none z-0"
                />
            </div>
        </div>
    );
    ...
    return (
        <section className="relative max-md:py-24 min-h-screen bg-[#050505] overflow-hidden flex flex-col md:flex-row items-end justify-between px-8 md:px-24 py-0">
            ...
            <div className="flex flex-col justify-center h-full max-w-xl text-right pb-24">
                ...
                >
                    Guardians of the <br /> <span className="text-zinc-500 font-light italic">Night</span>
                </motion.h2>
                ...
                >
                    Before the glow of screens filled our homes, the street lights
                    were our anchors. At GlowFarm, we recapture that steady,
                    soul-warming radiance, bringing the comfort of the
                    cobblestoned past into your modern sanctuary.
                </motion.p>
                ...
                <motion.div
                    ...
                    viewport={{ once: false }}
                    className="h-px bg-gradient-to-l from-white/30 to-transparent mt-12 self-end"
                />
            </div>
